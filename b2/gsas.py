...
gsas_bindist = os.path.join(sys.base_prefix, "GSASII/bindist")
gsas_bin = os.path.join(sys.base_prefix, "GSASII/bin")
gsas_path = os.path.join(sys.base_prefix, "GSASII")

for p in (gsas_bindist, gsas_bin, gsas_path):
...
class GSASModel:
    def __init__(self, project_file="TaTisim.gpx"):
        ...
        # see GSASIIstrMain.Refine source for PhaseData structure
        # to set up calculation controls...
        # https://gsas-ii.readthedocs.io/en/latest/_modules/GSASIIstrMain.html#Refine
